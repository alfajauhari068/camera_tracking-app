...
class _CameraTrackingPageState extends ConsumerState<CameraTrackingPage>
  ...
  // Zoom overlay state
  bool _zoomOverlayExpanded = false;
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    onPressed: () async {
                      ...
                      try {
                        await _shareService.shareLocationText(
                        ...
                        messenger.showSnackBar(
                          const SnackBar(
                            content: Text('Teks lokasi dibagikan'),
                            backgroundColor: Colors.green,
                          ),
                        );
                      } catch (error) {
                        ...
                        messenger.showSnackBar(
                          SnackBar(
                            content: Text(
                              error is ShareServiceException
                                  ? error.message
                                  : 'Gagal membagikan teks lokasi.',
                            ),
                            backgroundColor: Colors.orange,
                          ),
                        );
                ...
                SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    onPressed: () async {
                      ...
                      Navigator.pop(context);
                      try {
                        await _shareService.sharePhotoWithText(
                        ...
                        messenger.showSnackBar(
                          const SnackBar(
                            content: Text('Foto dan teks berhasil dibagikan'),
                            backgroundColor: Colors.green,
                          ),
                        );
                      } catch (error) {
                          ...
                          child: IgnorePointer(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                mainAxisSize: MainAxisSize.min,
                                children: [
                                  for (final z in _zoomPresets.where(
                                    (z) => z.value >= _minZoom,
                                  ))
                                    Padding(
                                      padding: const EdgeInsets.symmetric(
